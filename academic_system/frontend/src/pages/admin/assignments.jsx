...
export default function AdminAssignmentsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await adminAssignmentService.create(formData);
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-start gap-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  ...
                  <p className="text-xs text-blue-700 dark:text-blue-300">
                    <strong>Note:</strong> One faculty can only be assigned to one subject per semester/section.
                    A blank availability record will be created automatically.
                  </p>
                </div>
              ...
              {filteredAssignments.map((assignment) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => window.location.href = `/admin/faculty-availability?faculty_id=${assignment.faculty_id}&subject_id=${assignment.subject_id}&semester=${assignment.semester}&section=${assignment.section}&year=${assignment.academic_year}`}
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          window.location.href = `/admin/faculty-availability?faculty_id=${assignment.faculty_id}&subject_id=${assignment.subject_id}&semester=${assignment.semester}&section=${assignment.section}&year=${assignment.academic_year}`;
                        }}
